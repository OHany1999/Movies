...
class NewReleasesDetailsScreen extends StatelessWidget {
  static const String routeName = 'newReleases';

  @override
  Widget build(BuildContext context) {
    var arg = ModalRoute.of(context)?.settings.arguments as NewReleasesModel;
    return Scaffold(
